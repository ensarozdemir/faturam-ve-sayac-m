...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['ertelemeTarihi']) && isset($_POST['ertelemeNedeni'])) {
    ...
    if ($result_user) {
        if ($result_user->num_rows > 0) {
            ...
            $sql_check_subscription = "SELECT * FROM su_abonelik WHERE telefon='$userPhone'";
            ...
            if ($result_check_subscription) {
                if ($result_check_subscription->num_rows > 0) {
                    ...
                    $sql_update = "UPDATE su_abonelik SET ertelemeTarihi='$ertelemeTarihi', ertelemeNedeni='$ertelemeNedeni' WHERE telefon='$userPhone'";
